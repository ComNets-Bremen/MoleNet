...
#%% Zeitstempel lesbar machen und lokale Zeit anzeigen, nicht UTC, Zulu ...
...
# brauchen wir hier nciht, weil wir nur noch ein Gerät haben!

df = df[
    df["id"] == "igc-2025-06-19-otaa"
]

#%% Ausgabe einiger dinge zum debuggen
...
plt.title("2nd Run Varta Longlife AA fresh")
